...
define('MAIN_URL', ($_SERVER['HTTP_HOST'] == 'localhost' ? 'http://localhost/qcschina/' : 'http://qcschina.com/'));
...
define('CSS_RELATIVE_DIR', 'template/css/');
define('CSS_DIR', BASE_URL . CSS_RELATIVE_DIR);
define('JS_RELATIVE_DIR', 'template/js/');
define('JS_DIR', BASE_URL . JS_RELATIVE_DIR);
...
require_once('classes/AboutUsPage.php');
